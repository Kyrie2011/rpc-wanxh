...
import cn.rpc.common.util.GenericConstructor;
import cn.rpc.common.util.GenericType.Variable;
...
public class GenericClass {
     ...
     * @return 泛型
     */
    protected cn.rpc.common.util.GenericConstructor compute(final Constructor constructor) {
        ...
        return new cn.rpc.common.util.GenericConstructor(constructor, parameterTypes, exceptionsTypes);
    }
