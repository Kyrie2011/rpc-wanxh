...
import static cn.rpc.common.util.ClassUtils.*;
...
public class GenericChecker {
     ...
     * @param consumer 消费者
     */
    protected void checkReturnType(GenericMethod method, final Consumer<ClassInfo> consumer) {
     ...
     * @param consumer 消费者
     */
    protected void checkParameterTypes(GenericMethod method, final Consumer<ClassInfo> consumer) {
     ...
     * @param consumer 消费者
     */
    protected void checkExceptionTypes(GenericMethod method, final Consumer<ClassInfo> consumer) {
